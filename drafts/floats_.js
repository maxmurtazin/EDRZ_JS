...
///////////////////shift reg/////function/////RegShiftFunction///////////////////////
...
var Ar9 = 0x200; //0b10000000


/////////////////////////////////////////////////////////
const r = {
    regs: 0,
    on: function (addr) { return this.regs = this.regs | addr; },
    off: function (addr) { return   this.regs =this.regs |!addr; },
    sw: function  (addr) { return regs ^ !addr; }

}


function ShiftRegOn(addr) {
    dw(latchPin, 0);
...
function ShiftRegOff(addr) {
    dw(latchPin, 0);
    shOut(dataPin, clockPin,r.off(addr));
    dw(latchPin, 1);
}

function ShiftRegSw(addr) {
    dw(latchPin, 0);
...
var levelSensorD1 = require('@amperka/water-level').connect(P5, {mounted: 'onTop', debounce: 0.1});

var levelSensorC1 = require('@amperka/water-level').connect(P8, {mounted: 'onTop', debounce: 0.1});

var levelSensorD2 = require('@amperka/water-level').connect(P11, {mounted: 'onTop', debounce: 0.1});

var levelSensorC2 = require('@amperka/water-level').connect(P12, {mounted: 'onTop', debounce: 0.1});
